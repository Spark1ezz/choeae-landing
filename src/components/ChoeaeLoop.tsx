...
export default function ChoeaeLoop() {
  return (
    <section id="how-it-works" className="py-32 relative bg-midnight-plum text-pearl">
        ...
        <div className="relative max-w-4xl mx-auto py-10">
          ...
          <div className="flex flex-col items-center gap-16 relative z-10">
            ...
            <motion.div 
              ...
              className="glass px-8 py-4 rounded-full border border-white/10 flex items-center justify-center shadow-[0_0_30px_rgba(255,143,184,0.1)]"
            >
            ...
            <motion.div 
              ...
              className="w-32 h-44 rounded-lg bg-gradient-to-b from-white/10 to-transparent border border-white/20 flex flex-col items-center justify-center gap-2 glass-card shadow-[0_0_40px_rgba(255,255,255,0.05)]"
            >
            ...
            <motion.div 
              ...
              className="mt-8 glass px-12 py-6 rounded-full border border-holo-violet/30 flex items-center justify-center relative overflow-hidden group"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-choeae-pink/10 via-holo-violet/10 to-seoul-blue/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <span className="font-sora font-bold text-2xl tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-white to-white/70 flex items-center gap-3">
